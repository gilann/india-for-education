...
<div class="container-main-wrapper">
    ...
    <div class="container">
        ...
        <h1>Become Volunteer</h1>
            <form name="contact-form" action="addVolunteer.php" method="post" id="contact-form">
            ...
            <div class="form-group">
                ...
                <input type="text" name="mandal" class="form-control" placeholder="Your Mandal" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="subject" class="form-control" placeholder="Subject you wants to teach" required>
            </div>
            <div class="form-group">
                <label for="resource">Resource</label>
                <input type="text" name="resource" class="form-control" placeholder="Resource you want to share" required>
            </div>
            <div class="form-group">
                <label for="resource">contact</label>
                <input type="text" name="contact" class="form-control" placeholder="Your contact information" required>
            </div>
